...
white_color = Color.find_or_create_by!(name: 'White')

# Crear productos

# Producto 1: Zapatillas deportivas negras
shoes_product = Product.create!(
...
shoes_product.images.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'zapatillas1.jpg')), filename: 'zapatillas_negras_1.jpg')

# Producto 2: Gorra rosa
hat_product = Product.create!(
  name: 'Gorra Running x Adizero HEAT.RDY Liviana',
  category: accessories_category,
  color: red_color,  # Aunque es roja, puedes cambiarlo a rosa si añades ese color en la base de datos
...
hat_product.images.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'gorra.jpg')), filename: 'gorra_rosa_1.jpg')

# Producto 3: Camiseta de Argentina
shirt_product = Product.create!(
...
shirt_product.images.attach(io: File.open(Rails.root.join('app', 'assets', 'images', 'camiseta.jpg')), filename: 'camiseta_argentina_1.jpg')
